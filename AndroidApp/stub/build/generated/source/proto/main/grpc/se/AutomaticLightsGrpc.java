...
public final class AutomaticLightsGrpc {
        ...
        if ((getTurnOnOffMethod = AutomaticLightsGrpc.getTurnOnOffMethod) == null) {
          AutomaticLightsGrpc.getTurnOnOffMethod = getTurnOnOffMethod =
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  se.requestMessage.getDefaultInstance()))
              .setSchemaDescriptor(new AutomaticLightsMethodDescriptorSupplier("TurnOnOff"))
              .build();
        }
      }
    }
      ...
      synchronized (AutomaticLightsGrpc.class) {
        if ((getStatusMethod = AutomaticLightsGrpc.getStatusMethod) == null) {
          AutomaticLightsGrpc.getStatusMethod = getStatusMethod =
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  se.queryMessage.getDefaultInstance()))
              .setSchemaDescriptor(new AutomaticLightsMethodDescriptorSupplier("status"))
              .build();
        }
      }
    }
  ...
  private static abstract class AutomaticLightsBaseDescriptorSupplier
      implements io.grpc.protobuf.ProtoFileDescriptorSupplier, io.grpc.protobuf.ProtoServiceDescriptorSupplier {
    AutomaticLightsBaseDescriptorSupplier() {}

    @java.lang.Override
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return se.automaticLights.getDescriptor();
    }

    @java.lang.Override
    public com.google.protobuf.Descriptors.ServiceDescriptor getServiceDescriptor() {
      return getFileDescriptor().findServiceByName("AutomaticLights");
    }
  }

  private static final class AutomaticLightsFileDescriptorSupplier
      extends AutomaticLightsBaseDescriptorSupplier {
    AutomaticLightsFileDescriptorSupplier() {}
  }

  private static final class AutomaticLightsMethodDescriptorSupplier
      extends AutomaticLightsBaseDescriptorSupplier
      implements io.grpc.protobuf.ProtoMethodDescriptorSupplier {
    private final String methodName;

    AutomaticLightsMethodDescriptorSupplier(String methodName) {
      ...
      synchronized (AutomaticLightsGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              .setSchemaDescriptor(new AutomaticLightsFileDescriptorSupplier())
